    ...
    <div>
        ...
        <div>
            <div style="display: flex;">
                <div style="width: 20%;">
                    源结构
                    <!-- <vue-json-editor   v-model="aaaa" lang="zh" :modes="[]" :show-btns="false" :mode="'view'" style="user-select:none;"  :expanded-on-start="true"  /> -->
                                ...
                                <div v-for="(item,index) in data" :key="index">
                                    <div style="margin-left: 20px;">
                                        ...
                                        <div v-if="item.children&&item.children.length>0">
                                            <el-tree :expand-on-click-node="false" :style="'overflow:auto'" :data="item.children" :props="defaultProps" default-expand-all>
                                                <div slot-scope="{ data }">
                                                    <div v-if="!Array.isArray(data)">
                                                        <span @mousedown="handleDragStart" @mouseup="clearStartName" :name="data.name" style="user-select:none;">{{ data.key }}</span>
                                                        <span v-if="data.value&&(typeof data.value != 'object')">：{{ data.value }}</span>
